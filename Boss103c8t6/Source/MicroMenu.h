...
typedef const struct Menu_Item {
  ...
  void (*EnterCallback)(void);  /**< Pointer to the optional menu-specific enter
                                   callback of this menu item */
...
#define MENU_ITEM(Name, Next, Previous, Parent, Child, SelectFunc, EnterFunc, \
  ...
  Menu_Item_t const Name = {&Next,      &Previous, &Parent, &Child,           \
 ...
 * current menu text stored in \ref MENU_ITEM_STORAGE memory space.
 *
